...
def process_csv_files(s3, bucket_name, summaries, output_csv):
    ...
    for summary in summaries:
        ...
        try:
            ...
            if 'Window_Size' in df.columns and 'FDiv' in df.columns:
                summary_stats = df.groupby('Window_Size')['FDiv'].agg(
                    Median='median',
...
def main():
    ...
    search_criteria = "fdiv"
    output_csv = "results_summary.csv"
    destination_key = "/Fdiv_results_summary_1-20.csv"  # S3 path for the uploaded file
